...
export const metadata: Metadata = {
  ...
  keywords: 'UAV, drone, autonomous systems, defence drone India, agriculture drone, ISR UAV, swarm drone, DPIIT startup, iDEX, Make in India, zero Chinese components, India defence technology, indigenous UAV, Vortex Autonomous Systems',
  openGraph: {
